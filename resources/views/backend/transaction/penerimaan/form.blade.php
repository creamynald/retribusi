        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <div class="block-options">                    
                    <a href="{{ route('penerimaan.index') }}" class="btn-block-option">Kembali <i class="fa fa-fw fa-reply"></i></a>
                </div>
            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="kode_rekening" name="kode_rekening"
                                value="{{ old('kode_rekening') ?? $penerimaan->kode_rekening }}" autofocus placeholder="Kode Rekening">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-4">
                            ...
                            <input type="text" class="js-flatpickr form-control" id="tgl_penerimaan" name="tgl_penerimaan"
                                value="{{ old('tgl_penerimaan') ?? $penerimaan->tgl_penerimaan }}" autofocus placeholder="Tanggal Penerimaan">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-4">
                            <label class="form-label" for="tgl_penyetoran">Tanggal Penyetoran</label>
                            <input type="text" class="js-flatpickr form-control" id="tgl_penyetoran" name="tgl_penyetoran" placeholder="Tanggal Penyetoran" 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-4">
                            ...
                            <input type="file" class="form-control" id="bukti_pembayaran" name="bukti_pembayaran" placeholder="Bukti Pembayaran">
                        </div>
                    </div>
                </div>
            </div>
