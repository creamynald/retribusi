...
@section('title', 'Laporan Bulanan Dengan Total Rp.'.$penerimaan->sum('jumlah').',-')
            ...
            <div class="block-header block-header-default">
                ...
                @if (auth()->user()->upt_id == null )                    
                    <form action="" class="d-flex gap-2">
                        ...
                        <select class="js-select2 form-select" id="val-select3" name="bulan" data-placeholder="Bulan" style="width: 100px;" required>
                            <option></option>
                            @for ($i=1; $i<13 ; $i++)                        
                                <option value="{{$i}}" @if (isset($_GET['bulan'])) @if($_GET['bulan'] == $i) selected @endif @endif>{{$i}}</option>
                            @endfor
                        </select>
                    ...
                    <a href="{{url('admin/laporan/bulanan')}}"><button class="btn btn-sm btn-info m-2 p-2">Reset</button></a>
                @else
                    <form action="" class="d-flex gap-2">
                        <select class="js-select2 form-select" id="val-select3" name="bulan" data-placeholder="Bulan" style="width: 100px;" required>
                            <option></option>
                    ...
                    <a href="{{url('admin/laporan/bulanan')}}"><button class="btn btn-sm btn-info m-2 p-2">Reset</button></a>                @endif
            </div>
